...
const SERVER_MODULES = ["lib/auth.ts", "lib/db/client.ts", "lib/deployments.ts", "lib/multibaas/server.ts", "lib/ponder-server.ts", "lib/scan.ts", "lib/scryfall.ts", "lib/signer.ts", "lib/vault-site-uri.ts", "lib/world.ts"];
