...
const view = (over: Partial<AnalyticsView> = {}): AnalyticsView => ({
  ...
  tiles: { cardsInVault: 23, mintedInRange: 4, valueLocked: 412_860_000_000n, raised: 96_420_000_000n, raisedAuctions: 11, fees: 2_410_000_000n, liveAuctions: 3, nextEndsIn: 21n, collectors: 58 },
...
describe("Analytics dashboard (Y1eNn)", () => {
  it("shows the six tiles with the design's copy and the live fee", () => {
    ...
    for (const text of ["$412,860", "$96,420", "$2,410", "+4 this week", "across 11 auctions", "2.5% of sales + buyouts", "next ends in 04:12", "World ID, one per human"]) {
  ...
  it("says the vault is empty in each panel, with $0 tiles", () => {
    const zero = { cardsInVault: 0, mintedInRange: 0, valueLocked: 0n, raised: 0n, raisedAuctions: 0, fees: 0n, liveAuctions: 0, nextEndsIn: null, collectors: 0 };
